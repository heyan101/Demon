...
public final class Watermark {
     ...
     */
    public static BufferedImage pressText(Image image, String pressText, String fontName, int fontStyle, 
    		int fontSize, Color color, Integer x, Integer y, float alpha) {
