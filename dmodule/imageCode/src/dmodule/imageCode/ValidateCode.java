...
public class ValidateCode {
    ...
    public void createCode() {
        String code = randCode(codeCount);
        createCode(code);
    }

    /**
     * 生成随机验证码
     * @param codeCount 验证码的位数
     * @return code
     */
    public static String randCode(int codeCount) {
    ...
    public static void main(String[] args) {
        ValidateCode vCode = new ValidateCode(120, 50, 4, 100);
        try {
